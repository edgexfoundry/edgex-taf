...
if SECURITY_SERVICE_NEEDED == 'true':
    ...
    SUPPORT_NOTIFICATION_PORT = "8443/support-notifications"
    SUPPORT_SCHEDULER_PORT = "8443/support-scheduler"
    SUPPORT_RULESENGINE_PORT = "8443/rules-engine"
    ...
    SUPPORT_NOTIFICATION_PORT = 59860
    SUPPORT_SCHEDULER_PORT = 59861
    SUPPORT_RULESENGINE_PORT = 59701
