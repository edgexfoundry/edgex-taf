...
URI001-Test UoM URI with username-passward in URI
    Given Run Keyword If  $SECURITY_SERVICE_NEEDED == 'true'  Update core-metadata Configuration On Registry Service
    When Query UoM
...
URI002-Test configuration file, device profiles, devices and provision watchers with username-password in URI
    ...
    Given Run Keyword If  $SECURITY_SERVICE_NEEDED == 'true'  Update device-onvif-camera Configuration On Registry Service
...
Update core-metadata Configuration On Registry Service
