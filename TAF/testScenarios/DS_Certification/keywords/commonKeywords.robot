*** Variables ***
&{SERVICE_NAME_MAPPING}       consul=edgex-core-consul    data=edgex-core-data         metadata=edgex-core-metadata     device-modbus=edgex-device-modbus       device-virtual=device-virtual         device-random=edgex-device-random
