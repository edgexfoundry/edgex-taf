...
Generate Bad Simple Reading With ${property}
    Generate Event Sample  Event  Device-Test-002  Profile-Test-002  Command-Test-002  Simple Reading  Simple Reading
    ${no_property}=  Fetch From Right  ${property}  no_
...
Generate Bad Binary Reading With ${property}
    Generate Event Sample  Event  Device-Test-002  Profile-Test-002  Command-Test-002  Binary Reading
    ${no_property}=  Fetch From Right  ${property}  no_
