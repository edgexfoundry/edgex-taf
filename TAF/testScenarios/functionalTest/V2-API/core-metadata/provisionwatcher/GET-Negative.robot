...
ErrProWatcherGET001 - Query all provision watcher with non-int value on offset
    When Query All Provision Watchers With offset=Invalid
...
ErrProWatcherGET003 - Query provision watcher by non-existent device name
    When Query Provision Watchers By Name  Non-existent
...
ErrProWatcherGET004 - Query provision watcher by profile name with non-int value on offset
    When Query Provision Watchers By Profile Name With offset=Invalid
    Then Should Return Status Code "400"
    And Should Return Content-Type "application/json"
    And Response Time Should Be Less Than "${default_response_time_threshold}"ms

ErrProWatcherGET005 - Query provision watcher by profile name with non-int value on limit
    When Query Provision Watchers By Profile Name With limit=Invalid
    Then Should Return Status Code "400"
    And Should Return Content-Type "application/json"
    And Response Time Should Be Less Than "${default_response_time_threshold}"ms
...
ErrProWatcherGET006 - Query provision watcher by service name with non-int value on offset
    When Query Provision Watchers By Service Name With offset=Invalid
    Then Should Return Status Code "400"
    And Should Return Content-Type "application/json"
    And Response Time Should Be Less Than "${default_response_time_threshold}"ms

ErrProWatcherGET007 - Query provision watcher by service name with non-int value on limit
    When Query Provision Watchers By Service Name With limit=Invalid
    Then Should Return Status Code "400"
    And Should Return Content-Type "application/json"
    And Response Time Should Be Less Than "${default_response_time_threshold}"ms
