...
*** Variables ***
${SUITE}          Support Scheduler Action Record Get By Nqme Test Cases
${LOG_FILE_PATH}  ${WORK_DIR}/TAF/testArtifacts/logs/support-scheduler-action-record-get-name.log

*** Test Cases ***
SchedulerActionNameGET001 - Query schedule action record by name
...
SchedulerActionNameGET002 - Query schedule action record by name with start
...
SchedulerActionNameGET003 - Query schedule action record by name with end
    ${currentTime}  Get Current Milliseconds Epoch Time
...
SchedulerActionNameGET004 - Query schedule action record by name with start/end
    ${currentTime}  Get Current Milliseconds Epoch Time
...
SchedulerActionNameGET005 - Query schedule action record by name with offset
...
SchedulerActionNameGET006 - Query schedule action record by name with limit
...
Query Schedule Action Record By Job Name With Parameters
    ...
    ${resp}  GET On Session  Support Scheduler  ${scheduleActionRecordUri}/job/name/${name}  params=${params_dict}
