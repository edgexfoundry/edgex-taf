...
*** Variables ***
${SUITE}          Support Scheduler Job Delete Test Cases
${LOG_FILE_PATH}  ${WORK_DIR}/TAF/testArtifacts/logs/support-scheduler-delete.log

*** Test Cases ***
SchedulerJobDELETE001 - Delete job
...
ErrSchedulerJobDELETE001 - Delete job with invalid name
