...
exclude_secty_services = ["edgex-security-proxy-setup", "edgex-security-secretstore-setup", "edgex-nginx", "edgex-vault",
...
def show_the_summary_table_in_html(usages):
    ...
    <h4 style="margin:0px;color:blue">Threshold Setting: MINNESOTA value * {} </h4>
