...
prior_rel_image_footprint = {
    "edgex-core-keeper": {"imagesize": "{}".format(SettingsInfo().profile_constant.KEEPER_IMAGE)},
    ...
    "edgex-postgres": {"imagesize": "{}".format(SettingsInfo().profile_constant.POSTGRES_IMAGE)},
    ...
    "edgex-nginx": {"imagesize": "{}".format(SettingsInfo().profile_constant.NGINX_IMAGE)},
    "edgex-secret-store": {"imagesize": "{}".format(SettingsInfo().profile_constant.OPENBAO_IMAGE)},
...
prior_rel_image_footprint_arm64 = {
    "edgex-core-keeper": {"imagesize": "{}".format(SettingsInfo().profile_constant.KEEPER_IMAGE_ARM64)},
    ...
    "edgex-postgres": {"imagesize": "{}".format(SettingsInfo().profile_constant.POSTGRES_IMAGE_ARM64)},
    ...
    "edgex-nginx": {"imagesize": "{}".format(SettingsInfo().profile_constant.NGINX_IMAGE_ARM64)},
    "edgex-secret-store": {"imagesize": "{}".format(SettingsInfo().profile_constant.OPENBAO_IMAGE_ARM64)},
...
prior_rel_binary_footprint = {
    "edgex-core-keeper": {"binarysize": "{}".format(SettingsInfo().profile_constant.KEEPER_BINARY)},
    ...
    "edgex-postgres": {"binarysize": "{}".format(SettingsInfo().profile_constant.POSTGRES_BINARY)},
    ...
    "edgex-nginx": {"binarysize": "{}".format(SettingsInfo().profile_constant.NGINX_BINARY)},
    "edgex-secret-store": {"binarysize": "{}".format(SettingsInfo().profile_constant.OPENBAO_BINARY)},
...
prior_rel_binary_footprint_arm64 = {
    "edgex-core-keeper": {"binarysize": "{}".format(SettingsInfo().profile_constant.KEEPER_BINARY_ARM64)},
